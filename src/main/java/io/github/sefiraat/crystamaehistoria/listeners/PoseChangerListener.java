...
public class PoseChangerListener implements Listener {
    ...
    private static final String IMBUED_ONLY_MESSAGE = ThemeType.WARNING.getColor() + "该方法仅能对注入盔甲架使用";
            ...
            if (entity instanceof ArmorStand) {
                ...
                if (!armorStand.isMarker()
                    ...
                    if (player.isSneaking()) {
                        ...
                        player.sendActionBar(Component.text(ThemeType.WARNING.getColor() + "已应用造型"));
                    } else {
                        ...
                        player.sendActionBar(Component.text(ThemeType.WARNING.getColor() + "已保存造型"));
                    }
                }
            }
        }
